...
- 项目资料： [English README](./README.md) · [项目亮点](./docs/PROJECT_HIGHLIGHTS.zh-CN.md) · [系统架构](./docs/ARCHITECTURE.md) · [安全策略](./SECURITY.md) · [路线图](./ROADMAP.md) · [首发 Release 文案](./docs/RELEASE_v1.0.0.md) · [宣传文案包](./docs/LAUNCH_KIT.md) · [社区投递文案](./docs/COMMUNITY_POSTS.md) · [GitHub 文案包](./docs/GITHUB_ABOUT.zh-CN.md)
